...
PAGES = [
  ...
  ('battles.html',      'Ludo Battles | Khelbro',
   'Create a Ludo battle or join an open one. Lite mode and Rich mode tables with live opponents.', 'battles.js'),
  ('battle.html',       'Battle Room | Khelbro',
   'Your Ludo battle room — share the room code, play the match and submit the result.', 'battle.js'),
